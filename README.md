...
* `01_model_scenarios.R` carries out the main analysis. This includes loading model parameters, setting scenario values, initialising a stochastic transmission dynamic model using the excellent <pomp> package (https://kingaa.github.io/pomp/), running the simulations and visualising/saving some results.
